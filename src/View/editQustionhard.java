...
public class editQustionhard implements Initializable{
    ...
    void back(ActionEvent event) throws IOException {
    		...
    		Parent root = FXMLLoader.load(getClass().getResource("/View/QuestionViewHard.fxml"));
		...
		try {
		 ...
		 if(Level2<1 || Level2>3) {
			...
			if(q.getAnswers().contains(answer1) || q.getAnswers().contains(answer2) || 
				...
				SysData.getInstance().removeQuestion(QuestionViewHard.editQ3);
	...
	public void initialize(URL location, ResourceBundle resources) {
		...
		question q = QuestionViewHard.editQ3;
